...
class Calendar extends Component
{
    ...
    public function mount()
    {
        ...
        $this->sevenDayLater = $this->currentDate->addDays(7);
        $this->currentWeek = [];
        
        $this->events = EventService::getWeekEvents(
            $this->currentDate,
            $this->sevenDayLater->format('Y-m-d'),
        );
    ...
    public function getDate($date)
    {
        ...
        $this->currentWeek = [];
        $this->sevenDayLater = CarbonImmutable::parse($this->currentDate)->addDays(7);
