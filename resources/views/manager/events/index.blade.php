                ...
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-4 mx-auto">
                      ...
                      <div class="flex justify-between">
                        <button onclick="location.href='{{ route('events.past') }}'" class="flex mb-4 ml-auto text-white bg-gray-600 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">過去のイベント</button>
                        ...
                        <table class="table-auto w-full text-left whitespace-no-wrap">
                          <thead>
                            <tr>
                              ...
                              <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">店員</th>
